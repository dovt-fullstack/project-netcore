...
{
    public partial class newqw : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Specialties", x => x.DoctorId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialtiesDoctorId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.SpecialtiesDoctorId,
                        principalTable: "Specialties",
                        principalColumn: "DoctorId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentHistory_Doctors_DoctorsDoctorId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "DoctorId");
                    table.ForeignKey(
                        name: "FK_AppointmentHistory_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentHistory_DoctorsDoctorId",
                table: "AppointmentHistory",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentHistory_UserId",
                table: "AppointmentHistory",
                column: "UserId");
